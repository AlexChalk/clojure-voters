(ns clojure-voters.middleware
  (:require [clojure-voters.env :refer [defaults]]
            ...
            [clojure-voters.config :refer [env]]
...
; adds default joda time json encoder for muuntaja
...
(def restful-format-options
  (update
    ...
    {"application/json"
     ...
     ; different from cheshire/add-encoder as this adds transit encoder
     ; muuntaja handles serializing/deserializing data automatically 
     ; based on the Accept and Content-Type headers
     ; i.e. it handles what to encode into/out of
...
(defn wrap-base [handler]
  (-> ((:middleware defaults) handler)
      ...
      wrap-webjars
      wrap-flash
      ; enables session sharing with websockets 
